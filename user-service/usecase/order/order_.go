...
func (o *orderUsecase) CheckoutOrder(ctx context.Context, param model.CheckoutOrderRequest) (int, error) {
...
func (o *orderUsecase) sendRequestToAddStock(request model.AddStockProductRequest) error {
